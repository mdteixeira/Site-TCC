                ...
                (h.initialize = function () {
                    ...
                    (h.establishPreconnections = function () {
                        h.preconnect(h.getPlatformUrl()),
                            h.preconnect('https://static.elfsight.com'),
                            h.preconnect(
                    ...
                    (n.initWidget = function (t, r) {
                        if (i) {
                            ...
                            var a = {
                                    ...
                                    deactivate:
                                        1 === r.preferences.disable_widget,
                                    deactivatedWidgetUrl:
                                        r.preferences.deactivated_widget_url,
                                    showElfsightLogo:
                                        !r.preferences.hide_elfsight_logo,
                                    owner: r.isOwner,
                                    platform: r.platform,
                                    freeLinkUrl: r.preferences.free_link_url,
                                    displayFreeLink:
                                        !!r.preferences.display_free_link,
                                    displayFreeLinkRemove:
                                        !!r.preferences
                                            .display_free_link_remove,
                                    freeLinkURL: r.preferences.free_link_url,
                                    freeLinkRemoveURL:
                                        r.preferences.free_link_remove_url,
                                    freeLinkAnchor:
                                        r.preferences.free_link_anchor,
                                    displayDeactivation:
                                        !!r.preferences.display_deactivation,
                                    deactivationURL:
                                        r.preferences.deactivation_url,
                                },
                                s = n.getAttributeSettings(t);
                            (r.settings = [r.settings, a, s].reduce(function (
                                e,
                                t
                            ) {
                                return (
                            ...
                            o.push({ element: t, config: r, initialized: !1 });
                    }),
